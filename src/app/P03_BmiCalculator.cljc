...
(e/defn App []
        (let [!state (atom {:in2 "" :in3 "" :button1 "" :button2 "" :button3 "" :bg-color "black" :bg-color2 "black" :bg-color3 "black" :placeholder "..."}) !result (atom "")]
          (let [in2 (get (e/watch !state) :in2) in3 (get (e/watch !state) :in3)]
            (e/client
              ...
              (dom/dd
                (dom/select
                  (dom/on "change" (e/fn [e] (swap! !state assoc :button1 (-> e .-target .-value))
                                         (if
