...
(into [] map1)                                              ;==> => [[:foo 1] [:bar 2] [:baz 3]]
(into [] cat map1)                                          ;==> => [:foo 1 :bar 2 :baz 3]
(into [] cat map2)                                          ;==>=> [:foo 1 :bar {:baz 3}]
(into [] cat map3)                                          ;==> [:foo 1 :bar {:baz 3, :dax {:can 9}}]
(rf/transform-maps-to-vector map1)                          ;=> [:foo 1 :bar 2 :baz 3]
(rf/transform-maps-to-vector map2)                          ;=> [:foo 1 :bar [:baz 3]]
(rf/transform-maps-to-vector map3)                          ;=> [:foo 1 :bar [:baz 3 :dax [:can 9]]]
